...
export const CHARACTERS: Character[] = [
  {
    ...
    model: `${import.meta.env.BASE_URL}models/zombie/survivor_matt_armed.gltf`,
    apply: (s) => {
      s.damage += 1;
    },
  },
  {
    ...
    model: `${import.meta.env.BASE_URL}models/zombie/survivor_lis_armed.gltf`,
    apply: (s) => {
      s.moveSpeed *= 1.2;
      s.maxHp -= 25;
      s.projectileCount = 3;
  ...
  },
  {
    ...
    model: `${import.meta.env.BASE_URL}models/zombie/survivor_sam_armed.gltf`,
    apply: (s) => {
      s.fireInterval *= 0.55;
      s.maxHp -= 15;
    },
  },
  {
    ...
    model: `${import.meta.env.BASE_URL}models/zombie/survivor_shaun_armed.gltf`,
    apply: (s) => {
      s.pickupRadius *= 1.7;
      s.xpMultiplier *= 1.2;
      s.orbitalCount = 1;
  ...
  },
  {
    ...
    model: `${import.meta.env.BASE_URL}models/zombie/char_shepherd.gltf`,
    apply: (s) => {
      s.moveSpeed *= 1.15;
      s.range *= 1.15;
      s.lightningCount = 1;
  ...
  },
  {
    ...
    model: `${import.meta.env.BASE_URL}models/zombie/char_pug.gltf`,
    apply: (s) => {
      s.maxHp += 40;
      s.moveSpeed *= 0.9;
      s.auraRadius = 4;
  ...
  },
  {
    ...
    model: `${import.meta.env.BASE_URL}models/zombie/char_anne.gltf`,
    apply: (s) => {
      s.novaRadius = 6;
      s.novaDamage += 2;
    },
  },
  {
    ...
    model: `${import.meta.env.BASE_URL}models/zombie/char_mako.gltf`,
    apply: (s) => {
      s.critChance = 0.3;
      s.damage += 1;
    },
