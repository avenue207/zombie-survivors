...
/** by game register; used to exclude floating text from bloom (keeps text from blurring) */
...
/** One-shot particle burst, auto-cleared afterward */
function burst(
  scene: Scene,
  pos: Vector3,
  color: Color3,
...
/** Floating text (buff name, heal amount):billboard Text floats up and fades out */
export function spawnText(scene: Scene, pos: Vector3, text: string, colorHex: string, scale = 1) {
  ...
  /** Exclude bloom so text stays crisp */
